...
public abstract class AbstractEzalorHTTPServerAgent<T extends AbstractHTTPServerAgent<T, U, V>, U extends AbstractHTTPServerProtocol<U, T, V>, V extends AgentLink<?>> extends Agent<T, U, V> {
    ...
    protected AbstractEzalorHTTPServerAgent() {}

    protected AbstractEzalorHTTPServerAgent(String name) {
        super(name);
    }
